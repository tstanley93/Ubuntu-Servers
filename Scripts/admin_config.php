<?php
// HTTP
define('HTTP_SERVER', 'https://changeme.westus.cloudapp.azure.com/admin/');
define('HTTP_CATALOG', 'http://changeme.westus.cloudapp.azure.com/');

// HTTPS
define('HTTPS_SERVER', 'https://changeme.westus.cloudapp.azure.com/admin/');
define('HTTPS_CATALOG', 'https://changeme.westus.cloudapp.azure.com/');
...
define('DB_HOSTNAME', '1.1.1.1');
define('DB_USERNAME', 'opencart');
define('DB_PASSWORD', 'SquidJ1g');
